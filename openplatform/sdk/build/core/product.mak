...
# for usb host - uvc application
ifeq ($(SYSCONFIG_PROJECT), gplus.cvr_dual)
	rootfs_modules += gp_usb.ko
	rootfs_modules += usbcore.ko
	rootfs_modules += gp_ehset.ko
#	rootfs_modules += ehci-hcd.ko
#	rootfs_modules += uvcvideo.ko
endif
...
ifeq ($(SYSCONFIG_RM_UBOOT), y)
	...
	cd $(PRODUCT_DIR)/
ifeq ($(SYSCONFIG_PRODUCT), gplus.cvr_dual__gplus.cvr_turnkey_evm)	
	./uclinux_packer -k ./Image -r ./initramfs_oImage.igz -c ./kernel_bootparam.txt -l ./loader_12b.bin -i ./oImage -sm 36 -cm 90
else
	./uclinux_packer -k ./Image -r ./initramfs_oImage.igz -c ./kernel_bootparam.txt -l ./loader_12b.bin -i ./oImage -sm 32 -cm 94
endif
