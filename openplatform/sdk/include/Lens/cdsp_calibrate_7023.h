...
#ifndef _CDSP_CALIBRATE_7023_H_
#define _CDSP_CALIBRATE_7023_H_
...
static const unsigned short g_ar0330_lens_7023_r_b_gain[71][2] = 
{ // { r gain, b gain }  
#if 0 //using 3.8K ÊÒÄÚÆ«ºì
{39, 213},
{42, 208},
{45, 204},
{47, 199},
...
#define GAMMA_N_2 2
#define GAMMA_N_3 3
#define GAMMA_N_7023 4
#define GAMMA_N_SVN 5
#define GAMMA_N_MY 6
#define GAMMA_N_MY2 7
#define GAMMA_N GAMMA_N_0

static const unsigned int g_ar0330_lens_7023_gamma_table_test[] = 
{
#if (GAMMA_N == GAMMA_N_7023) //7023
...
static const short g_ar0330_lens_7023_color_matrix4gamma045[9] = 
{	
...
static const short g_ar0330_lens_7023_awb_thr[19] = 
{
	200, // awbwinthr
...
sensor_calibration_t ar0330_cdsp_calibration = 
{
	...
	.wb_gain = g_ar0330_lens_7023_r_b_gain,
	.wbgain_size = sizeof(unsigned short)*71*2,
	.gamma1 = g_ar0330_lens_7023_gamma_table_test,
	.gamma1_size = sizeof(unsigned int)*128,
	.color_matrix1 = g_ar0330_lens_7023_color_matrix4gamma045,
	.matrix1_size = sizeof(short)*9,
	.gamma2 = g_ar0330_lens_7023_gamma_table_test,
	.gamma2_size = sizeof(unsigned int)*128,
	.color_matrix2 = g_ar0330_lens_7023_color_matrix4gamma045,
	.matrix2_size = sizeof(short)*9,
	.awb_thr = g_ar0330_lens_7023_awb_thr,
