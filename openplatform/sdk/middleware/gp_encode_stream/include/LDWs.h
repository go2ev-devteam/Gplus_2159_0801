...
typedef struct
{
	...
	int sensitiveMode; // low sensitive = 0, high sensitive = 1, unlimited sensitive = 2 
	...
	int LTP_X_Buff[5];
	int RTP_X_Buff[5];
	int switch_TP_Buff_Index_L;
	int switch_TP_Buff_Index_R;
	...
	int nonSpeedChangeCheckCnt;
	
	int bestGSThre;
	int parkingCarFixBestGSThre;
	int GValueTable[8];
	int totalGValueCnt;
	int lastGValue;

	int sumGV_XYZeqOneCnt;
	int sumGV_XYZ;   // 1 G = 64
	int sumGVFrameCnt;
	int minSumGV;
	int sumGVBias;

	int last_GSTilStatus;
	int GSTilStatus;
	int GSTilUpCheckCnt;
	int GSTilDownCheckCnt;


	int GSensorSpeed0Cnt;
	int GSensorStopCnt;
	int GSensorStopEnergy;
	int GSensorStopEnergyThre;
	int GSensorGoCnt;
	...
	int stopMovingOptCntThreL;
	int stopMovingOptCntThreR;
	...
	int SFCWROI_shiftX_60km;    //two side rect , value more large more far
	int SFCWROI_shiftX_80km;    //two side rect , value more large more far
...
void GSensorStatusDetect(int x, int y, int z, LDWsParameter *par);
