...
extern INT32S ap_state_resource_string_ascii_draw_update(INT16U *frame_buff, STRING_ASCII_INFO *str_ascii_info, INT8U* old_string);
...
INT32S ap_state_resource_string_ascii_resolution_get(void *str_name, INT16U type, t_STRING_TABLE_STRUCT *str_res);