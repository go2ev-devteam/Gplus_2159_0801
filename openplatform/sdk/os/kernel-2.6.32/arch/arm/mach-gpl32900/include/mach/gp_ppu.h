...
#define	TXT_BITMAP_FLIP_DISABLE		    (((unsigned int) 0)<<B_TXT_BITMAP_FLIP)
#define	TXT_BITMAP_FLIP_ENABLE			(((unsigned int) 1)<<B_TXT_BITMAP_FLIP)
#define	B_PPU_ARGB888				    24
#define	PPU_ARGB888_DISABLE		    (((unsigned int) 0)<<B_PPU_ARGB888)
#define	PPU_ARGB888_ENABLE			(((unsigned int) 1)<<B_PPU_ARGB888)
#define	B_TFT_FLIP				18
#define	TFT_FLIP_DISABLE		    (((unsigned int) 0)<<B_TFT_FLIP)
#define	TFT_FLIP_ENABLE			(((unsigned int) 1)<<B_TFT_FLIP)
#define	B_TV_FLIP				17
#define	TV_FLIP_DISABLE		    (((unsigned int) 0)<<B_TV_FLIP)
#define	TV_FLIP_ENABLE			(((unsigned int) 1)<<B_TV_FLIP)
...
#define PPU_MODULE_ILLEGAL_WRITE			  0x00020000
 ...
 */
#define PPUIO_TYPE                                    'D'
#define PPU_TEXT_BASE                                 0x40
#define PPU_SPRITE_BASE                               0x70
/* PPU Module */
...
#define PPUIO_SET_PPU_FBLOCK                          _IOW(PPUIO_TYPE, 0x2A, unsigned int)
#define PPUIO_SET_PPU_ENABLE                          _IOW(PPUIO_TYPE, 0x2B, unsigned int)
#define PPUIO_SET_PPU_ILLEGAL_WRITE_STATE_GET         _IOW(PPUIO_TYPE, 0x2C, unsigned int)
#define PPUIO_SET_TEXT_BITMAP_FLIP_ENABLE            	_IOW(PPUIO_TYPE, 0x2D, unsigned int)
#define PPUIO_SET_TV_FLIP_ENABLE            	        _IOW(PPUIO_TYPE, 0x2E, unsigned int)
#define PPUIO_SET_TFT_FLIP_ENABLE            	        _IOW(PPUIO_TYPE, 0x2F, unsigned int)
#define PPUIO_SET_PPU_ARGB888_ENABLE            	    _IOW(PPUIO_TYPE, 0x30, unsigned int)                                         																																				
/* PPU TEXT Module */                         																																				
#define PPUIO_TEXT_SET_INIT                       	  _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x00, unsigned int)																																				
#define PPUIO_TEXT_SET_ENABLE                 				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x01, unsigned int)																																				
#define PPUIO_TEXT_SET_COMPRESS_DISABLE       				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x02, unsigned int)																																				
#define PPUIO_TEXT_SET_MODE                   				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x03, unsigned int)																																				
#define PPUIO_TEXT_SET_DIRECT_MODE            				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x04, unsigned int)																																				
#define PPUIO_TEXT_SET_WALLPAPER_MODE         				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x05, unsigned int)																																																						
#define PPUIO_TEXT_SET_ATTRIBUTE_SOURCE       				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x06, unsigned int)																																																						
#define PPUIO_TEXT_SET_HORIZONTAL_MOVE_ENABLE 				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x07, unsigned int)																																																						
#define PPUIO_TEXT_SET_TEXT_SIZE              				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x08, unsigned int)																																																						
#define PPUIO_TEXT_SET_CHARACTER_SIZE         				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x09, unsigned int)																																																						
#define PPUIO_TEXT_SET_BITMAP_MODE            				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0A, unsigned int)																																																						
#define PPUIO_TEXT_SET_COLOR                  				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0B, unsigned int)																																																						
#define PPUIO_TEXT_SET_PALETTE                				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0C, unsigned int)																																																						
#define PPUIO_TEXT_SET_SEGMENT                				_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0D, unsigned int)																																																						
#define PPUIO_TEXT_SET_ATTRIBUTE_ARRAY_PTR   				 	_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0E, unsigned int)
#define PPUIO_TEXT_SET_NUMBER_ARRAY_PTR       			  _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x0F, unsigned int)
#define PPUIO_TEXT_CALCULATE_NUMBER_ARRAY             _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x10, unsigned int)
#define PPUIO_TEXT_SET_POSITION   				 	          _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x11, unsigned int)
#define PPUIO_TEXT_SET_OFFSET       			            _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x12, unsigned int)
#define PPUIO_TEXT_SET_DEPTH                          _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x13, unsigned int)
#define PPUIO_TEXT_SET_BLEND   				 	              _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x14, unsigned int)
#define PPUIO_TEXT_SET_FLIP       			              _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x15, unsigned int)
#define PPUIO_TEXT_SET_SINE_COSINE                    _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x16, unsigned int)
#define PPUIO_TEXT_SELECT_WINDOW   				 	          _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x17, unsigned int)
#define PPUIO_TEXT_SET_SPECIAL_EFFECT       			    _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x18, unsigned int)
#define PPUIO_TEXT_SET_VERTICAL_COMPRESS              _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x19, unsigned int)
#define PPUIO_TEXT_SET_HORIZONTAL_MOVE_PTR  				 	_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1A, unsigned int)
#define PPUIO_TEXT_SET_HORIZONTAL_COMPRESS_PTR       	_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1B, unsigned int)
#define PPUIO_TEXT_SET_ROTATE_ZOOM                    _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1C, unsigned int)
#define PPUIO_TEXT3_SET_25D  				 	                _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1D, unsigned int)
#define PPUIO_TEXT3_SET_25D_Y_COMPRESS              	_IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1E, unsigned int)
#define PPUIO_TEXT3_SET_25D_COSINEBUF                 _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x1F, unsigned int)
#define PPUIO_TEXT_SET_INTERPOLATION  				 	      _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x20, unsigned int)
#define PPUIO_TEXT_SET_COLOR_MASK              	      _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x21, unsigned int)
#define PPUIO_TEXT_UPDATE_NUMBER_ARRAY                _IOW(PPUIO_TYPE, PPU_TEXT_BASE+0x22, unsigned int)

/* PPU SPRITE Module */ 
#define PPUIO_SPRITE_SET_INIT	                        _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x00, unsigned int)
#define PPUIO_SPRITE_SET_ENABLE	                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x01, unsigned int)	
#define PPUIO_SPRITE_SET_COORDINATE	                  _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x02, unsigned int)	
#define PPUIO_SPRITE_SET_BLEND	                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x03, unsigned int)
#define PPUIO_SPRITE_SET_DIRECT	                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x04, unsigned int)	
#define PPUIO_SPRITE_SET_ZOOM_ENABLE	                _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x05, unsigned int)
#define PPUIO_SPRITE_SET_ROTATE_ENABLE	              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x06, unsigned int)
#define PPUIO_SPRITE_SET_MOSAIC_ENABLE	              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x07, unsigned int)	
#define PPUIO_SPRITE_SET_NUMBER	                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x08, unsigned int)
#define PPUIO_SPRITE_SET_SPECIAL_EFFECT	              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x09, unsigned int)
#define PPUIO_SPRITE_SET_COLOR_DITHER	                _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0A, unsigned int)	
#define PPUIO_SPRITE_SET_WINDOW                       _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0B, unsigned int)
#define PPUIO_SPRITE_SET_SEGMENT                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0C, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_RAM_PTR            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0D, unsigned int)	
#define PPUIO_SPRITE_SET_SFR	                        _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0E, unsigned int)
#define PPUIO_SPRITE_SET_LARGE_ENABLE                 _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x0F, unsigned int)
#define PPUIO_SPRITE_SET_INTERPOLATION_ENABLE         _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x10, unsigned int)	
#define PPUIO_SPRITE_SET_GROUP_ENABLE	                _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x11, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_CDM_ENABLE         _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x12, unsigned int)
#define PPUIO_SPRITE_SET_FRACTION_ENABLE              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x13, unsigned int)	
#define PPUIO_SPRITE_SET_EXTEND_ATTRIBUTE_RAM_PTR	    _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x14, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_ENABLE                  _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x15, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_CDM_ENABLE              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x16, unsigned int)	
#define PPUIO_SPRITE_SET_EXSP_INTERPOLATION_ENABLE	  _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x17, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_LARGE_SIZE_ENABLE       _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x18, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_GROUP_ENABLE            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x19, unsigned int)	
#define PPUIO_SPRITE_SET_EXSP_FRACTION_ENABLE	        _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1A, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_NUMBER                  _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1B, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_START_ADDRESS           _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1C, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_2D_POSITION	      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1D, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_25D_POSITION       _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1E, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_ROTATE             _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x1F, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_ZOOM	              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x20, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_COLOR              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x21, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_FLIP               _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x22, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_CHARACTER_SIZE     _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x23, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_PALETTE            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x24, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_DEPTH              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x25, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_BLEND64            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x26, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_BLEND16            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x27, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_WINDOW             _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x28, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_MOSAIC             _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x29, unsigned int)
#define PPUIO_SPRITE_SET_ATTRIBUTE_CHARNUM            _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2A, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_ATTRIBUTE_GROUP         _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2B, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_GROUP              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2C, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_ATTRIBUTE_LARGE_SIZE    _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2D, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_LARGE_SIZE         _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2E, unsigned int)
#define PPUIO_SPRITE_SET_EXSP_ATTRIBUTE_INTERPOLATION _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x2F, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_INTERPOLATION      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x30, unsigned int)
#define PPUIO_SPRITE_SET_SP_ATTRIBUTE_CDM             _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x31, unsigned int)	
#define PPUIO_SPRITE_SET_ATTRIBUTE_COLOR_MASK         _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x32, unsigned int)
#define PPUIO_SPRITE_SET_IMAGE_DATA_INIT              _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x33, unsigned int)	
#define PPUIO_SPRITE_SET_DISPLAY                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x34, unsigned int)
#define PPUIO_SPRITE_SET_IMAGE_NUMBER                 _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x35, unsigned int)	
#define PPUIO_SPRITE_SET_DISABLE                      _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x36, unsigned int)
#define PPUIO_SPRITE_GET_IMAGE_INFO                   _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x37, unsigned int)	
#define PPUIO_SPRITE_PAINT_SPRITERAM                  _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x38, unsigned int)
#define PPUIO_SPRITE_SET_25D                          _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x39, unsigned int)
#define PPUIO_SPRITE_SET_SPRAM                        _IOW(PPUIO_TYPE, PPU_SPRITE_BASE+0x3A, unsigned int)
...
typedef struct {
	unsigned short	 fb_lock_en; 
	unsigned short	 TV_color_mode;                                
	unsigned short	 TV_frame_hsize;
	unsigned short	 TV_frame_vsize;
	unsigned short	 TFT_color_mode;
	unsigned short	 TFT_frame_hsize;
	unsigned short	 TFT_frame_vsize;                                	 	
} PPU_FBLOCK_STRUCT, *PPU_FBLOCK_STRUCT_PTR;
...
typedef struct {
	...
	signed short	  nSP_Xpos;                           //  1.  X position of sprite image
	signed short	  nSP_Ypos;                           //  2.  Y position of sprite image	
	unsigned short	nSP_Hsize;                          //  3.  H size of sprite image
	unsigned short	nSP_Vsize;                          //  4.  V size of sprite image
	unsigned int	nSPNum_ptr;                           //  5.  sprite image pointer of sprite ram  		
	unsigned int	nEXSPNum_ptr;                         //  6.  sprite image pointer of sprite exram		
} SpN_ptr, *PSpN_ptr;
...
#define C_UPDATE_REG_SET_COLOR				0x00000040
	...
	unsigned int buffer_user_define;
...
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_fblock_set(PPU_FBLOCK_STRUCT *fb_lock);
...
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_enable_set(void);
...
/**
 * @brief 	PPU flip mode for text bitmap set function.
* @param 	p_register_set [in]: PPU struct value set.
* @param 	value [in]: value:0=disable 1=enable.
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_text_bitmap_flip_enable_set(PPU_REGISTER_SETS *p_register_set, unsigned int value);

/**
 * @brief 	PPU tv flip mode enable function.
* @param 	p_register_set [in]: PPU struct value set.
* @param 	value [in]: value:0=disable 1=enable.
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_tv_flip_enable_set(PPU_REGISTER_SETS *p_register_set, unsigned int value);

/**
 * @brief 	PPU tft flip mode enable function.
* @param 	p_register_set [in]: PPU struct value set.
* @param 	value [in]: value:0=disable 1=enable.
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_tft_flip_enable_set(PPU_REGISTER_SETS *p_register_set, unsigned int value);
...
* @return 	SUCCESS/ERROR_ID.
*/
extern signed int gp_ppu_argb888_enable_set(PPU_REGISTER_SETS *p_register_set, unsigned int value);
