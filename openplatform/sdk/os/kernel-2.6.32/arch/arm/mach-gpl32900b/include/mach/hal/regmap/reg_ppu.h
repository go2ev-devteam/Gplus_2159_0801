...
typedef struct ppuFunReg_s {
    ...
    volatile  UINT8 offset05[0x0084];	/* offset00, 0x93020140 ~ 0x930201C4*/
	volatile UINT32 reserved02;			/* reserved02, 0x930201C4 */
	volatile UINT32 reserved03;			/* reserved03, 0x930201C8 */	   
...
typedef struct pputvFun_s {
  volatile  UINT8 offset00[0x00f0];	/* offset00, 0x93020000 ~ 0x930200F0*/
	volatile UINT32 ppuTvEn;		      /* P_PPUTV_EN, 0x930200F0 */
} pputvFun_t;

typedef struct pputftFun_s {
  volatile  UINT8 offset00[0x0140];	/* offset00, 0x93020000 ~ 0x93020140*/
	volatile UINT32 ppuTftEn;		      /* P_PPUTFT_EN, 0x93020140 */
} pputftFun_t;
#endif /* _REG_PPU_H_ */
