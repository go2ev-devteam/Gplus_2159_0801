...
#define C_PPU_INT_PEND_PPU_MASK				0x00027C3D
...
* @return 	none
*/
extern void gpHalPPUCtrl(UINT32 enable);
...
* @return 	none
*/
extern void gpHalPPUFblock(PPU_FBLOCK_STRUCT *fb_lock);
/**
* @brief	ppu enable set
* @return 	none
*/
extern void gpHalPPUEnset(void);
/**
* @brief	       ppu module register set
* @return 	success=0,fail=-1.
*/
extern SINT32 gpHalPPUSimpleGo(PPU_REGISTER_SETS *p_register_set);
...
extern void gpHalPPUSet576mode(UINT32 enable);
extern UINT32 gpHalPPUEnget(void);
extern UINT32 gpHalPPUInterlaceEnget(void);
extern UINT32 gpHalPPUGetFbEnable(void);
#endif
