...
////////////////////LDW disp line//////////
#if CVR_DUAL
	#define X_DIV_LCD_320240_16_9 1/4   //320/1920	
	#define Y_DIV_LCD_320240_16_9 34/135   //272/1080 maybe 270/1080=1/4  
#else
	#define X_DIV_LCD_320240_16_9 1/6   //320/1920
	#define Y_DIV_LCD_320240_16_9 2/9   //240/1080 
#endif
#define X_DIV_LCD_320240_4_3 1/6   //320/1920
#define Y_DIV_LCD_320240_4_3 1/6+30   //240/1080  +30  
#define X_DIV_TV_640426		3/8-40		//720/1920 osd  为640*426,720转为640时左右留边40
#define Y_DIV_TV_640426 	3/8+10		//for 16:9,1920*1080->720*405
//////////////////////////////////////////

#define LDW_LINEDISP	1//disp LDW CheckLine && Alarm Line
#define LDW_FCW 0
#define LDW_STOPANDGO 0///1
#define ADAS_CALIBRATE 0
#define ADAS_OPEN_WARNING 0//open Adas(ldw or fcw or s&g),disp warning message
...
#define FONT_SELECT_COLOR	0x001f
	...
	#define DV_MENU_NUM 	10
#else
	#define DV_MENU_NUM 	9
#endif

#define DV_SETTING_NUM_DEF		10

#ifdef SYSCONFIG_DISP0_TVOUT
#define DV_SETTING_TVOUT	1
#else
#define DV_SETTING_TVOUT	0
#endif

#define DV_SETTING_NUM		(DV_SETTING_NUM_DEF+DV_SETTING_TVOUT+CVR_PLATE_NUMBER)
...
#endif
	STR_ADAS_CALIBRATE,
	STR_ADAS_GSENSOR_PARA,
	STR_ADAS_INSTALL_GUIDE,

	STR_CALIBRATE_NOTOK_WARING,//未校准，请校准  开机后spi无数据则提示
	STR_CALIBRATE_VERTICAL_SATTIC,//垂直静止防止
	STR_CALIBRATE_GSENSOR_PARAING,//传感器校正中
	STR_CALIBRATE_GSENSOR_OK,//gsensor cok
	STR_CALIBRATE_CARTYPE_CHOICE,//请选择车型
	STR_CALIBRATE_ARROW_DISP,//水平线重合，上下调整
	STR_CALIBRATE_ARROW_OK,//no arrow disp ,note Press Ok to make sure
	STR_CALIBRATE_FINAL_OK,//adas ok

	STR_ADAS_WARNING_TITLE,//adas 警示声明的title
	STR_ADAS_WARNING,//adas 警示声明内容
	STR_ACCEPT,
	STR_ADAS_SOUND,
...
enum {
	ADAS_CALIBRATE_NULL 			=	0,
	ADAS_CALIBRATE_NOTOK_WARING		=   1,
	ADAS_CALIBRATE_VERTICAL_SATTIC		,
	ADAS_CALIBRATE_GSENSOR_PARAING		,
	ADAS_CALIBRATE_GSENSOR_OK			,
	ADAS_CALIBRATE_CARTYPE_CHOICE		,
	ADAS_CALIBRATE_ARROW_DISP			,
	ADAS_CALIBRATE_ARROW_OK				,
	ADAS_CALIBRATE_FINAL_OK				,
};
