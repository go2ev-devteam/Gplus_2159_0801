...
insmod /system/lib/modules/common/8189es.ko
ifconfig wlan1 up
...
/system/bin/hostapd /media/$sdpath/wifi/hostapd_2G.conf &
...
/system/bin/dnsmasq -C /media/$sdpath/wifi/dnsmasq.conf -I /media/$sdpath/wifi/dnsmasq.leases
