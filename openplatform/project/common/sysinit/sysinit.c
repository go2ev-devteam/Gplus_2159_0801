...
)
{
	...
	if(strcmp(SYSCONFIG_PLATFORM, "gplus.cvr_turnkey_evm") == 0 ||
		...
		strcmp(SYSCONFIG_PLATFORM, "gplus.cvr_dual_turnkey_demo0") == 0 ||
		strcmp(SYSCONFIG_PLATFORM, "gplus.cvr_turnkey_demo1") == 0  ||
		strcmp(SYSCONFIG_PLATFORM, "gplus.cvr_turnkey_demo2") == 0 ) {
		pllsel = 2;
		showbg = 0;
	} else {
		pllsel = 0;
...
)
{
	if (strcmp(SYSCONFIG_PRODUCT, "gplus.microwindowsUI__gplus.evm32900b") != 0) {
		...
		if (strcmp(SYSCONFIG_PROJECT, "gplus.cvr_dual")==0) {
...
{
	if (strcmp(SYSCONFIG_WIFI, "None") != 0) {
		if (strcmp(SYSCONFIG_WIFI, "AR9271") == 0) {
			...
			if (strcmp(SYSCONFIG_PRODUCT, "gplus.microwindowsUI__gplus.evm32900b") != 0) {
				insmod("/lib/modules/common/%s.ko", SYSCONFIG_WIFI);
			}
	}
