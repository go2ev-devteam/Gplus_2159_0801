...
#define SYSCONFIG_A_SENSOR

#define SYSCONFIG_A_SENSOR_DEVICE "Asensor_DA380"
...
/* #undef SYSCONFIG_CVR_FCW */

/* #undef SYSCONFIG_CVR_STOPANDGO */
...
/* #undef SYSCONFIG_EVALUATION_ONLY */
