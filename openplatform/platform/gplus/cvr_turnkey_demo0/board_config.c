...
//dc_in_detect
	...
	if( !(IS_ERR_VALUE(gp_board_info->handle_core_1v2_voltage) ) )
		gp_adc_start(gp_board_info->handle_core_1v2_voltage, 1);
...
*Tv
*****************************************************************************/
	gpiocfgInput(tv_detect_channel,tv_detect_func,tv_detect_gid,tv_detect_pin);
/**************************************************************************
 * Pwm
 **************************************************************************/
...
static int tv_decet()
{
	...
	//gp_gpio_set_function( handle, GPIO_FUNC_GPIO );//set io as GPIO mode
	//gp_gpio_set_direction( handle, GPIO_DIR_INPUT);
	//gp_gpio_set_pullfunction(handle, GPIO_PULL_HIGH);
	//gp_gpio_set_pullfunction(handle, GPIO_PULL_LOW);
	gp_gpio_set_pullfunction(handle, GPIO_PULL_FLOATING);
