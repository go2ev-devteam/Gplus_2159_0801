...
#define DEMO0_HW_VERSION_1 1
#define DEMO0_HW_VERSION_3 3

#define DEMO0_HW_VERSION DEMO0_HW_VERSION_3
...
#define	sd2_set_power_channel	0xff
#define	sd2_set_power_func		2
#define	sd2_set_power_gid		23
#define	sd2_set_power_pin		12
 ...
 **************************************************************************/
#define	sensor0_set_reset_channel	0xff
...
#define	sensor0_set_standby_channel	0xff
#define	sensor0_set_standby_func	2
#define	sensor0_set_standby_gid		23
#define	sensor0_set_standby_pin		12
#define	sensor0_set_standby_active	1

#define	sensor0_set_power_channel	0xff
#define	sensor0_set_power_func		2
#define	sensor0_set_power_gid		23
 ...
 * LED Control
 **************************************************************************/
#if (DEMO0_HW_VERSION == DEMO0_HW_VERSION_3)
