...
{1307, (int)(1.45*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.52*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.52*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.60*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.68*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.68*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.78*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.88*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(1.88*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.0*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.13*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.13*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.29*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.29*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.46*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.46*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.67*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.67*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.67*256), (int)(1.07*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.91*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.91*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(2.91*256), (int)(1.07*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.20*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.20*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.20*256), (int)(1.07*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.56*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.56*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(3.56*256), (int)(1.07*AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.00*AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.04*AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.07 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.11 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.15 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.19 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.23 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.27 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.32 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.37 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.41 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.46 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.52 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.57 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.62 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.68 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.74 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.80 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.87 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(1.93 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.00 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.07 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.14 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.22 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.30 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.38 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.46 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.55 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.64 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.73 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.83 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(2.93 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.03 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.14 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.25 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.36 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.48 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.61 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.73 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(3.86 *AR0330_MIN_D_GAIN*256)},
{1307, (int)(4.0*256), (int)(4.00 *AR0330_MIN_D_GAIN*256)}
};
...
)
{
	...
	AR0330WrTable((regval16_t *)AR0330_Reset_Cmd);

	
	//ret = AR0330_read( 0x300e, &R0x300E );
	//if(ret < 0) return ret;
	ret = AR0330_read( 0x30f0, &R0x30F0 );
	if(ret < 0) return ret;
	ret = AR0330_read( 0x3072, &R0x3072 );
	if(ret < 0) return ret;

	//printk("R0x300E = 0x%x, R0x30F0 = 0x%x, R0x3072 = 0x%x\r\n", R0x300E, R0x30F0, R0x3072);
	if(/*R0x300E == 0x10 && */R0x30F0 == 0x1200/* && R0x3072 == 0x00*/)
	{	// rev 1
		AR0330WrTable((regval16_t *)AR0330_OTPM_V1);
		AR0330WrTable((regval16_t *)AR0330_SequencerA);
		printk("OTPM_V1\r\n");
	}
	else if(/*R0x30F0 == 0x1208 &&*/ R0x3072 == 0x00)
	{	// rev 2
		AR0330WrTable((regval16_t *)AR0330_OTPM_V2);
		AR0330WrTable((regval16_t *)AR0330_SequencerB);
		printk("OTPM_V2\r\n");
	}
	else if(/*R0x300E == 0x20 && R0x30F0 == 0x1208 &&*/ R0x3072 == 0x06)
	{	// rev 2.1
		AR0330WrTable((regval16_t *)AR0330_OTPM_V3);
		AR0330WrTable((regval16_t *)AR0330_SequencerPatch1);
		printk("OTPM_V3\r\n");
	}
	else if(/*R0x300E == 0x20 && R0x30F0 == 0x1208 && */R0x3072 == 0x07)
	{	// rev 2.1
		AR0330WrTable((regval16_t *)AR0330_OTPM_V4);
		printk("OTPM_V4\r\n");
	}
	else if(/*R0x300E == 0x20 && R0x30F0 == 0x1208 &&*/ R0x3072 == 0x08)
	{	// rev 2.1
		AR0330WrTable((regval16_t *)AR0330_OTPM_V5);	
		printk("OTPM_V5\r\n");
	}
	else
	{
